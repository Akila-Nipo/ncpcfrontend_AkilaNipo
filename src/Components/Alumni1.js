            ...
            <Container fluid="true" className='alumniFullBanner text-center pb-5'>
                ...
                <Row className="p-0 mx-5 rowBackground">
                    <Col md={4} lg={4} sm={12} className="m-0 px-0 alumniColumn">
                        <h3 className="alumniTitle text-dark">ALUMNI SUCCESS STORIES</h3>
                        <hr/>
                        <p className="alumniDescription text-dark">The Department of Computer Science and Engineering,Jahangirnagar University, has seen a constellation of alumni shining brightly in various programming contests, both nationally and internationally. These individuals have not just secured good positions but have also etched the department's and the university's name in the hall of fame within the tech world.</p>
                    </Col>
                            ...
                            <Carousel.Item>
                                <div className="carouselItemContainerAlumni">
                                    ...
                                    <div className="carouselCaptionAlumni">
                                        ...
                                        <p className="alumniDescriptionInside text-white text-center">Anik Sarker, Sakib Hasan, Chayan Kumar Ray representing Jahangirnagar University at the ICPC 2021 World Finals Dhaka.</p>
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item>
                                <div className="carouselItemContainerAlumni">
                                    ...
                                    <h3 className="whiteTitle">JU_kzvd4729</h3>
                                        <p className="alumniDescriptionInside text-white text-center">JU_kzvd4729 led by Mahmudul Hasan Shanto(CSE-46), Richita Khandakar Rifat(CSE-46) and Alif Al Hasan(CSE-47) secured 3rd place at the 2021 ICPC Asia Regional Dhaka Contest.</p>
                                    </div>
                                </div>
                            </Carousel.Item>
                        </Carousel>
