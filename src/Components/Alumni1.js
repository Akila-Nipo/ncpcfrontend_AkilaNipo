                        ...
                        <Carousel.Item>
                                <div className="carouselItemContainerAlumni">
                                    ...
                                    <div className="carouselCaptionAlumni">
                                        ...
                                        <p className="alumniDescription text-white text-center">Aninda Majumder(CSE), Md. Nafis Sadique(IIT), Suman Bhadra(CSE) participated at the ACM-ICPC 2015 World Finals and solved 6 problems.</p>
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item>
                                <div className="carouselItemContainerAlumni">
                                    ...
                                    <div className="carouselCaptionAlumni">
                                        ...
                                        <p className="alumniDescription text-white text-center">Md. Nafis Sadique(IIT), Niloy Datta(IIT), Raihat Zaman Neloy(CSE) secured 50th place at the ACM-ICPC 2016 World Finals solving 6 problems. </p>
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item>
                                <div className="carouselItemContainerAlumni">
                                    ...
                                    <div className="carouselCaptionAlumni">
                                        ...
                                        <p className="alumniDescription text-white text-center">Bir Bahadur Khatri, Md Sahedul Islam Sohel, Raihat Zaman Neloy at the ACM-ICPC 2017 World Finals. </p>
                                    </div>
                                </div>
                            </Carousel.Item>
                            <Carousel.Item>
                            ...
                            <Carousel.Item>
                                <div className="carouselItemContainerAlumni">
                                    ...
                                    <h3 className="whiteTitle">JU_kzvd4729</h3>
                                        <p className="alumniDescription text-white text-center">JU_kzvd4729 led by Mahmudul Hasan Shanto(CSE-46), Richita Khandakar Rifat(CSE-46) and Alif Al Hasan(CSE-47) secured 3rd place at the 2021 ICPC Asia Regional Dhaka Contest.</p>
                                    </div>
                                </div>
                            </Carousel.Item>
                        </Carousel>
